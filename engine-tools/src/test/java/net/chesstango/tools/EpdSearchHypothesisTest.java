...
public class EpdSearchHypothesisTest {
    ...
    public void test_WAC003() {
        ...
        assertEquals(40, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(39, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_WAC008() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(43, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(42, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_WAC012() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(26, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(25, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_WAC137() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(56, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(55, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_WAC072() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(36, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(35, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_WAC111() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(27, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(26, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_WAC283() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(34, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(33, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_BK04() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(38, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(37, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_BK05() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(51, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(50, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_BK06() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(24, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(23, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_BK23() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(35, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(34, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_40H_10390() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(21, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(20, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_40H_9482() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(32, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(31, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_40H_079() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(44, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(43, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_40H_2462() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(46, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(45, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_40H_10021() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(46, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(44, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_40H_022() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(52, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(51, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_40H_10255() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(54, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(53, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_40H_1027() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(16, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(15, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_40H_3243() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(47, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(46, epdSearchResult.getExpectedRootBestMoveCounter());
    }
    ...
    public void test_sbd_058() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(30, FENDecoder.loadGame(epd.getFenWithoutClocks()).getPossibleMoves().size());
        assertEquals(29, epdSearchResult.getExpectedRootBestMoveCounter());
    }
