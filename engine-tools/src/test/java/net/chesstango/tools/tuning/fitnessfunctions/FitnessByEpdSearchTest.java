...
public class FitnessByEpdSearchTest {
    ...
    public void test_white01() {
        ...
        FitnessByEpdSearch fitnessFn = new FitnessByEpdSearch(files, 2);
    ...
    public void testEvaluatorImp05_default() {
        ...
        fitnessByEpdSearch.start();
        long points = fitnessByEpdSearch.fitness(EvaluatorImp05::new);
        fitnessByEpdSearch.stop();
    ...
    public void testEvaluatorImp06_default() {
        ...
        fitnessByEpdSearch.start();
        long points = fitnessByEpdSearch.fitness(EvaluatorImp06::new);
        fitnessByEpdSearch.stop();
