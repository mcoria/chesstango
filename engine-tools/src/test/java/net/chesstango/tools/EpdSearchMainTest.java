...
public class EpdSearchMainTest {
    ...
    public void test_WAC003() {
        epdSearch.setSearchMoveSupplier(() -> buildSearchMove(new EvaluatorImp04()));
    ...
    public void test_BK04() {
        epdSearch.setSearchMoveSupplier(() -> buildSearchMove(new EvaluatorImp04()));
        epdSearch.setDepth(5);
        EpdEntry epdEntry = epdReader.readEdpLine("rnbqkb1r/p3pppp/1p6/2ppP3/3N4/2P5/PPP1QPPP/R1B1KB1R w KQkq - bm e6; id \"BK.04\";");
        epdSearchResult = epdSearch.run(epdEntry);
        assertTrue(epdSearchResult.isSearchSuccess());
    }
    ...
    public void test_40H_1027() {
        epdSearch.setSearchMoveSupplier(() -> buildSearchMove(new EvaluatorImp04()));
        epdSearch.setDepth(5);
        EpdEntry epdEntry = epdReader.readEdpLine("kbK5/pp6/1P6/8/8/8/R7/8 w - - bm Ra2-a6; ce +M2; pv Ra2-a6 b7xa6 b6-b7+; id \"1027\";");
        epdSearchResult = epdSearch.run(epdEntry);
        assertTrue(epdSearchResult.isSearchSuccess());
    }
