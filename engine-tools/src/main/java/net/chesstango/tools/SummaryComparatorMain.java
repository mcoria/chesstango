...
public class SummaryComparatorMain {
    ...
    public static void main(String[] args) {
        ...
        summaryComparatorMain.addSession("depth-5-2024-03-04-09-30-CHT-156");
        summaryComparatorMain.addSession("depth-5-2024-04-08-13-53-CHT-253");
        summaryComparatorMain.addSession("depth-5-2024-04-08-22-51-CHT-253");
        //depth-5-2024-04-08-22-51-CHT-253
