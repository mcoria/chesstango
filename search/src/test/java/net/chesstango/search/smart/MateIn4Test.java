...
public abstract class MateIn4Test {
    ...
    public void test1() {
        Game game = FENParser.loadGame("r2r1n2/pp2bk2/2p1p2p/3q4/3PN1QP/2P3R1/P4PP1/5RK1 w - - 0 1");
    ...
    public void test2() {
        Game game = FENParser.loadGame("7R/r1p1q1pp/3k4/1p1n1Q2/3N4/8/1PP2PPP/2B3K1 w - - 1 0");
    ...
    public void test3() {
        Game game = FENParser.loadGame("Q7/p1p1q1pk/3p2rp/4n3/3bP3/7b/PP3PPK/R1B2R2 b - - 0 1");
    ...
    @Test
    public void test8() {
        Game game = FENParser.loadGame("1k1r3r/pp6/2P1bp2/2R1p3/Q3Pnp1/P2q4/1BR3B1/6K1 b - - 0 1");
