...
public abstract class MateIn3Test {
    ...
    public void test1() {
        Game game = Game.fromFEN("1k5r/pP3ppp/3p2b1/1BN1n3/1Q2P3/P1B5/KP3P1P/7q w - - 1 0");
    ...
    public void test2() {
        Game game = Game.fromFEN("3r4/pR2N3/2pkb3/5p2/8/2B5/qP3PPP/4R1K1 w - - 1 0");
    ...
    public void test3() {
        Game game = Game.fromFEN("R6R/1r3pp1/4p1kp/3pP3/1r2qPP1/7P/1P1Q3K/8 w - - 1 0");
    ...
    public void test4() {
        Game game = Game.fromFEN("4r1k1/5bpp/2p5/3pr3/8/1B3pPq/PPR2P2/2R2QK1 b - - 0 1");
    ...
    public void test5() {
        Game game = Game.fromFEN("2r5/2p2k1p/pqp1RB2/2r5/PbQ2N2/1P3PP1/2P3P1/4R2K w - - 1 0");
    ...
    public void test6() {
        Game game = Game.fromFEN("r3k2r/ppp2Npp/1b5n/4p2b/2B1P2q/BQP2P2/P5PP/RN5K w kq - 1 0");
