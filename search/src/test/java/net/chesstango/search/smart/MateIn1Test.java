...
public abstract class MateIn1Test {
    ...
    public void testQueenWhiteCheckMate() {
        ...
        Game game = FENParser.loadGame("rnbqkbnr/2pppppp/8/pp4N1/8/4PQ2/PPPP1PPP/RNB1KB1R w KQkq - 0 5");
    ...
    public void testQueenBlackCheckMate() {
        ...
        Game game = FENParser.loadGame("rnb1kb1r/pppp1ppp/4pq2/PN6/1P4n1/8/2PPPPPP/R1BQKBNR b KQkq - 0 7");
    ...
    public void testKingTrapped() {
        ...
        Game game = FENParser.loadGame("1k6/6R1/7Q/8/2KP3P/5P2/4P1P1/1N3BNR w - - 0 40");
    ...
    public void testFoolsMateTest() {
        // Fool's mate
        Game game = FENParser.loadGame("rnbqkbnr/pppp1ppp/4p3/8/6P1/5P2/PPPPP2P/RNBQKBNR b KQkq - 0 2");
