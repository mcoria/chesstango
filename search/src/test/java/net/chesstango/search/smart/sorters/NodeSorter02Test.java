...
public class NodeSorter02Test extends AbstractNodeSorterTest {
    ...
    private void loadKillerMoveTables() {
        ...
        killerMovesTable.trackKillerMove(2, moveFactoryWhite.createSimpleKnightMove(PiecePositioned.getPiecePositioned(Square.g2, Piece.KNIGHT_WHITE), PiecePositioned.getPosition(Square.h4)));
    }
}
