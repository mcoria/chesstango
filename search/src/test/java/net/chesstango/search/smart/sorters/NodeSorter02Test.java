...
public class NodeSorter02Test extends AbstractNodeSorterTest {
    ...
    protected Game createGame() {
        return Game.from(FEN.from("1R3b1k/2p3pp/4qr2/Q7/3p2P1/3P3K/6NP/8 b - - 0 1"))
    ...
    private void loadKillerMoveTables() {
        ...
        killerMovesTable.trackKillerMove(createMove(PiecePositioned.of(Square.g2, Piece.KNIGHT_WHITE), PiecePositioned.getPosition(Square.h4), null, true), 1);
    }
