...
public abstract class MateIn2Test {
    ...
    public void testQueenMove1() {
        Game game = Game.from(FEN.from("5K2/1b6/2p1Bp2/2N1k3/1B3p2/2pQ2n1/1b2pp2/8 w - - 0 1"));
    ...
    public void testQueenMove2() {
        Game game = Game.from(FEN.from("8/8/5p2/1R1Nk3/R7/7K/8/1Q6 w - - 0 1"));
    ...
    public void testKnightMove1() {
        Game game = Game.from(FEN.from("r2qkb1r/pp2nppp/3p4/2pNN1B1/2BnP3/3P4/PPP2PPP/R2bK2R w KQkq - 1 1"));
    ...
    public void testPromotion() {
        Game game = Game.from(FEN.from("2r2r2/6kp/3p4/3P4/4Pp2/5P1P/PP1pq1P1/4R2K b - - 0 1"));

        SearchResult searchResult = search.startSearch(game);

        Move smartMove = searchResult.getBestMove();

        assertEquals(Piece.PAWN_BLACK, smartMove.getFrom().piece());
        assertEquals(Square.d2, smartMove.getFrom().square());
