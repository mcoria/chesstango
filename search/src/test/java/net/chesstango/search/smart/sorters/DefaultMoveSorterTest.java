...
public class DefaultMoveSorterTest {
    ...
    public void testCapture01() {
        ...
        Game game = FENParser.loadGame("rnb1kbnr/pppp1ppp/4p3/5q2/4P2N/8/PPPP1PPP/RNBQKB1R w KQkq - 4 4");
    ...
    public void testCapture01Mirror() {
        ...
        Game game = FENParser.loadGame("rnbqkb1r/pppp1ppp/8/4p2n/5Q2/4P3/PPPP1PPP/RNB1KBNR b KQkq - 4 1");
    ...
    public void testCapture02() {
        ...
        Game game = FENParser.loadGame("1nb1k1nr/pppp1ppp/4p1b1/3r1q2/4P2N/8/PPPP1PPP/RNBQKB1R w KQk - 4 1");
    ...
    public void testCapture02Mirror() {
        ...
        Game game = FENParser.loadGame("rnbqkb1r/pppp1ppp/8/4p2n/3R1Q2/4P1B1/PPPP1PPP/1NB1K1NR b Kkq - 4 1");
    ...
    public void testGamesMirror() {
        testMirror(FENParser.loadGame(FENParser.INITIAL_FEN));
        testMirror(FENParser.loadGame("r4rk1/1pp2ppp/p2b1n2/3pp3/8/PPNbPN2/3P1PPP/R1B1K2R b KQ - 0 14"));
        testMirror(FENParser.loadGame("2r1nrk1/p2q1ppp/bp1p4/n1pPp3/P1P1P3/2PBB1N1/4QPPP/R4RK1 w - - 0 1"));
        testMirror(FENParser.loadGame("r1bqk2r/pp2bppp/2p5/3pP3/P2Q1P2/2N1B3/1PP3PP/R4RK1 b kq - 0 1"));
        testMirror(FENParser.loadGame("rnb1kbnr/pppp1ppp/4p3/5q2/4P2N/8/PPPP1PPP/RNBQKB1R w KQkq - 4 4"));
        testMirror(FENParser.loadGame("1nb1k1nr/pppp1ppp/4p1b1/3r1q2/4P2N/8/PPPP1PPP/RNBQKB1R w KQk - 4 1"));
    }
