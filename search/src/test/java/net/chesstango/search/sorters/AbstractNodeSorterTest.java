...
import net.chesstango.search.alphabeta.AlphaBetaHelper;
import net.chesstango.search.alphabeta.killermoves.KillerMovesTable;
import net.chesstango.search.ListenerMediator;
import net.chesstango.search.alphabeta.transposition.TTableMap;
...
public abstract class AbstractNodeSorterTest {
    ...
    protected EvaluatorCacheArray gameEvaluatorCacheArray;
    protected Game game;
