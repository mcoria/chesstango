...
public class BestMoveSearchSuiteTest {
    ...
    @Test
    public void test01() {
        BestMoveSearchSuite finderSuite = new BestMoveSearchSuite(8);
    ...
    @Test
    public void test02() {
        BestMoveSearchSuite finderSuite = new BestMoveSearchSuite(4);
    ...
    @Test
    public void test03() {
        BestMoveSearchSuite finderSuite = new BestMoveSearchSuite(1);
    ...
    @Disabled
    public void test04() {
        BestMoveSearchSuite finderSuite = new BestMoveSearchSuite(7);
