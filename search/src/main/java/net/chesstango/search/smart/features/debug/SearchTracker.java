...
public class SearchTracker {
    ...
    private void trackTranspositionsAccess() {
        ...
        for (Move move : game.getPossibleMoves()) {
            ...
            entryReads.stream()
                    .filter(debugNodeTT -> moveEncoded == AlphaBetaHelper.decodeMove(debugNodeTT.getEntry().getMovesAndValue()))
        ...
        entryReads
                ...
                .forEach(debugNodeTT -> debugNodeTT.setMove(AlphaBetaHelper.decodeMove(debugNodeTT.getEntry().getMovesAndValue()) == 0 ? "NO_MOVE" : "UNKNOWN"));
