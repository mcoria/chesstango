...
public class SearchTracker {
    ...
    private void trackTranspositionsAccess() {
        ...
        for (Move move : game.getPossibleMoves()) {
            ...
            entryReads.stream()
                    .filter(debugNodeTT -> moveEncoded == AlphaBetaHelper.decodeBestMove(debugNodeTT.getEntry().getMovesAndValue()))
        ...
        entryReads
                ...
                .forEach(debugNodeTT -> debugNodeTT.setMove(AlphaBetaHelper.decodeBestMove(debugNodeTT.getEntry().getMovesAndValue()) == 0 ? "NO_MOVE" : "UNKNOWN"));
