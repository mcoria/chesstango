...
import net.chesstango.search.smart.alphabeta.core.visitors.SetSearchLastNullVisitor;
import net.chesstango.search.smart.alphabeta.core.visitors.SetSearchLastVisitor;
