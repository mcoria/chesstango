...
import net.chesstango.search.alphabeta.evaluator.*;
...
import net.chesstango.search.alphabeta.statistics.transposition.TTableStatisticsComparatorCollector;
import net.chesstango.search.alphabeta.statistics.transposition.TTableStatisticsNodeCollector;
import net.chesstango.search.alphabeta.statistics.transposition.TTableStatisticsPVCollector;
...
public class ChainPrinterVisitor implements Visitor {
    ...
    public void visit(QSStandingPat qsStandingPat) {
        ...
        printChainText(String.format("%s [Evaluator: %s]", objectText(qsStandingPat), printGameEvaluator(qsStandingPat.getEvaluator())));

        traverse(qsStandingPat.getNext());
    }
