package net.chesstango.search.alphabeta.debug.iterators;

import net.chesstango.search.*;
import net.chesstango.search.alphabeta.debug.DebugIterator;
import net.chesstango.search.alphabeta.debug.DebugIteratorHandler;
...
import static net.chesstango.search.alphabeta.debug.model.DebugReadTT.*;
...
public class PrintHtmlDebugHandler implements DebugIteratorHandler, Acceptor {
    ...
    private void dumpSorterOperations(DebugNode currentNode) {
        ...
        List<DebugReadTT> sortedHeadReads = currentNode.getSorterHeadReads();

        List<DebugReadTT> sortedTailReads = currentNode.getSorterTailReads();
        ...
        sortedMoves.forEach(moveStr -> {
            ...
            evalCacheReads.stream()
                    ...
                    {
                        debugOut.print("<li class=\"myText\">");
                        debugOut.printf("%s Cache [ 0x%s value=%12d ]%n",
                                moveStr,
