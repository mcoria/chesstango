...
public class SANDecoderTest {
    ...
    public void test_check01() {
        Game game = FENDecoder.loadGame("6k1/5p2/p6p/1pQ3P1/2n1B3/2P1PpP1/q4r2/4R1K1 b - - 0 37");
    ...
    public void test_check02() {
        Game game = FENDecoder.loadGame("r1bq1rk1/ppp2ppp/3p1n2/3Np3/1bPnP3/5NP1/PP1P1PBP/R1BQ1RK1 b - - 3 8");
