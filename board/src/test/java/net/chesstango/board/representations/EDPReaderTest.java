...
public class EDPReaderTest {
    ...
    public void testReadEDP01(){
        ...
        assertEquals("Rd1xd8+", entry.bestMoves);
    ...
    public void testReadEDP02(){
        ...
        assertEquals("O-O-O", entry.bestMoves);
        assertNotNull(entry.game);
        assertNotNull(entry.expectedMove);
    }
    ...
    public void testReadEDP03(){
        ...
        assertEquals("Rh4+", entry.bestMoves);
        assertNotNull(entry.game);
        assertNotNull(entry.expectedMove);
    }
    ...
    public void testReadEDP04(){
        ...
        assertEquals("h5xg6+", entry.bestMoves);
        assertNotNull(entry.game);
        assertNotNull(entry.expectedMove);
    }
    ...
    public void testReadEDP05(){
        ...
        assertEquals("c7-c8N+", entry.bestMoves);
        assertNotNull(entry.game);
        assertNotNull(entry.expectedMove);
    }
    ...
    public void testReadEDP06(){
        ...
        assertEquals("Qxh7+", entry.bestMoves);
        assertNotNull(entry.game);
        assertNotNull(entry.expectedMove);
    }
    ...
    public void testReadEDP07(){
        ...
        assertEquals("Nca4", entry.bestMoves);
        assertNotNull(entry.game);
        assertNotNull(entry.expectedMove);
    }
    ...
    public void testReadEDP08(){
        ...
        assertEquals("Qxa8 d6 dxe6", entry.bestMoves);
        assertNotNull(entry.game);
        assertEquals(3, entry.expectedMove.size());
    }
