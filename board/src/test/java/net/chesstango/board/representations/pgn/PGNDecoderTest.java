...
public class PGNDecoderTest {
    ...
    public void decodeMoveList01() {
        ...
        Assert.assertEquals("e4 c5", moves.get(0));
        Assert.assertEquals("O-O-O", moves.get(7));
    }
    ...
    public void decodeMoveList02() {
        ...
        Assert.assertEquals("e3 d5", moves.get(0));
        Assert.assertEquals("Ke2 Ne4", moves.get(41));
    }
    ...
    public void decodeGame01() throws IOException {
        ...
        Assert.assertEquals("Be2", moves.get(5));
    }
