...
public class KingWhiteMoveGeneratorTest {
	...
	public void test01() {
		...
		PiecePositioned origen = PiecePositioned.of(from, Piece.KING_WHITE);
	...
	public void test03() {
		...
		assertEquals(Piece.KING_WHITE, tablero.getPiece(PiecePositioned.KING_WHITE.square()));
		assertEquals(Piece.ROOK_WHITE, tablero.getPiece(Square.a1));
		
		PiecePositioned origen = PiecePositioned.of(PiecePositioned.KING_WHITE.square(), Piece.KING_WHITE);
	...
	private Move createCaptureMove(PiecePositioned origen, Square destinoSquare, Piece destinoPieza) {
		return moveFactoryImp.createCaptureKingMove(origen, PiecePositioned.of(destinoSquare, destinoPieza));
	}
