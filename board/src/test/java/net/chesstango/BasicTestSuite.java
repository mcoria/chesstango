...
import net.chesstango.board.moves.generators.legal.imp.CheckLegalMoveGeneratorTest;
import net.chesstango.board.moves.generators.legal.imp.NoCheckLegalMoveGeneratorTest;
