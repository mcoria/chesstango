...
public class NoCheckMoveFilter implements MoveFilter {
	...
	protected final KingCacheBoardImp kingCacheBoard;
	...
	public NoCheckMoveFilter(Board dummyBoard, KingCacheBoardImp kingCacheBoard, ColorBoard colorBoard, PositionStateReader positionState) {
