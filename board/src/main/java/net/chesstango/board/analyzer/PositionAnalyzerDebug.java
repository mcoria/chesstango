...
public class PositionAnalyzerDebug extends PositionAnalyzer {
    ...
    @Setter
    protected KingSquareReader kingCacheBoard = null;
    ...
    public AnalyzerResult analyze() {
        try {
            ...
            KingSquareImp kingCacheBoardInicial = ((KingSquareImp) this.kingCacheBoard).clone();
    ...
    public void setBoardState(PositionState positionStateWriter) {
