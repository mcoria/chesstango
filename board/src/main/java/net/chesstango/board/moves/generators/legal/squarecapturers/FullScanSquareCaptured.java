package net.chesstango.board.moves.generators.legal.squarecapturers;

import net.chesstango.board.Color;
import net.chesstango.board.Square;
import net.chesstango.board.moves.generators.legal.squarecapturers.bypiece.CapturerByKing;
import net.chesstango.board.moves.generators.legal.squarecapturers.bypiece.CapturerByKnight;
import net.chesstango.board.moves.generators.legal.squarecapturers.bypiece.CapturerByPawn;
import net.chesstango.board.moves.generators.legal.squarecapturers.bypiece.CapturerByPiece;
