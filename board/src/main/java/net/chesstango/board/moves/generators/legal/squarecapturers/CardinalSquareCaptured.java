...
import net.chesstango.board.moves.generators.legal.squarecapturers.bypiece.CapturerByBishop;
import net.chesstango.board.moves.generators.legal.squarecapturers.bypiece.CapturerByPiece;
import net.chesstango.board.moves.generators.legal.squarecapturers.bypiece.CapturerByRook;
