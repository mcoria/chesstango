...
public class TournamentMain {
    ...
    private static List<String> getFenList(){
        //List<String> fenList = new Transcoding().pgnFileToFenPositions(TournamentMain.class.getClassLoader().getResourceAsStream("Balsa_Top10.pgn"));
    ...
    private static List<EngineControllerFactory> createOpponentsControllerFactories() {
        ...
        EngineControllerFactory factory4 = new EngineControllerFactory(() -> createTangoController(GameEvaluatorImp01.class));
