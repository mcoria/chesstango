...
import chess.board.movesgenerators.pseudo.strategies.AbstractKingMoveGenerator;
import chess.board.movesgenerators.pseudo.strategies.AbstractMoveGenerator;
import chess.board.movesgenerators.pseudo.strategies.BishopMoveGenerator;
import chess.board.movesgenerators.pseudo.strategies.KingBlackMoveGenerator;
import chess.board.movesgenerators.pseudo.strategies.KingWhiteMoveGenerator;
import chess.board.movesgenerators.pseudo.strategies.KnightMoveGenerator;
import chess.board.movesgenerators.pseudo.strategies.PawnBlackMoveGenerator;
import chess.board.movesgenerators.pseudo.strategies.PawnWhiteMoveGenerator;
import chess.board.movesgenerators.pseudo.strategies.QueenMoveGenerator;
