...
public class ReyNegroMoveGeneratorTest {
	...
	public void testEnroqueNegroReina01() {
		PosicionPiezaBoard tablero =  builder.constructTablero("r3k3/8/8/8/8/8/8/8").getBuilder().buildPosicionPiezaBoard();
	...
	public void testEnroqueNegroReina02() {
		PosicionPiezaBoard tablero =  builder.constructTablero("r3k3/8/5B2/8/8/8/8/8").getBuilder().buildPosicionPiezaBoard();
	...
	public void testEnroqueNegroReina03() {
		PosicionPiezaBoard tablero =  builder.constructTablero("r3k3/8/8/5B2/8/8/8/8").getBuilder().buildPosicionPiezaBoard();
	...
	public void testEnroqueNegroRey03() {
		PosicionPiezaBoard tablero =  builder.constructTablero("4k2r/8/8/3B4/8/8/8/8").getBuilder().buildPosicionPiezaBoard();
	...
	public void testEnroqueNegroJaque() {
		PosicionPiezaBoard tablero =  builder.constructTablero("r3k2r/8/8/4R3/8/8/8/8").getBuilder().buildPosicionPiezaBoard();
