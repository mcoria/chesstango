...
public class MoveGeneratorEnPassantImpTest {
	...
	public void testPawnWhitePasanteIzquierda() {
		...
		Assert.assertEquals(Piece.PAWN_WHITE, tablero.getPiece(from));
		Assert.assertEquals(Piece.PAWN_BLACK, tablero.getPiece(Square.d5));
	...
	public void testPawnWhitePasanteDerecha() {
		...
		Assert.assertEquals(Piece.PAWN_WHITE, tablero.getPiece(from));
		Assert.assertEquals(Piece.PAWN_BLACK, tablero.getPiece(Square.e5));
	...
	public void testPawnBlackPasanteDerecha() {
		...
		Assert.assertEquals(Piece.PAWN_BLACK, tablero.getPiece(from));
		Assert.assertEquals(Piece.PAWN_WHITE, tablero.getPiece(Square.e4));
	...
	public void testPawnBlackPasanteIzquierda() {
		...
		Assert.assertEquals(Piece.PAWN_BLACK, tablero.getPiece(from));
		Assert.assertEquals(Piece.PAWN_WHITE, tablero.getPiece(Square.d4));
