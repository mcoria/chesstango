...
public class KingBlackMoveGeneratorTest {
	...
	public void test01() {
		...
		Assert.assertEquals(Piece.KING_BLACK, tablero.getPiece(PiecePositioned.KING_BLACK.getKey()));
		Assert.assertEquals(Piece.ROOK_BLACK, tablero.getPiece(Square.a8));
	...
	public void test02() {
		...
		Assert.assertEquals(Piece.KING_BLACK, tablero.getPiece(PiecePositioned.KING_BLACK.getKey()));
		Assert.assertEquals(Piece.ROOK_BLACK, tablero.getPiece(Square.a8));
		Assert.assertEquals(Piece.BISHOP_WHITE, tablero.getPiece(Square.f6));
	...
	public void test03() {
		...
		Assert.assertEquals(Piece.KING_BLACK, tablero.getPiece(PiecePositioned.KING_BLACK.getKey()));
		Assert.assertEquals(Piece.ROOK_BLACK, tablero.getPiece(Square.a8));
		Assert.assertEquals(Piece.BISHOP_WHITE, tablero.getPiece(Square.f5));
	...
	public void test04() {
		...
		Assert.assertEquals(Piece.KING_BLACK, tablero.getPiece(PiecePositioned.KING_BLACK.getKey()));
		Assert.assertEquals(Piece.ROOK_BLACK, tablero.getPiece(Square.h8));
	...
	public void test05() {
		...
		Assert.assertEquals(Piece.KING_BLACK, tablero.getPiece(PiecePositioned.KING_BLACK.getKey()));
		Assert.assertEquals(Piece.ROOK_BLACK, tablero.getPiece(Square.h8));
		Assert.assertEquals(Piece.BISHOP_WHITE, tablero.getPiece(Square.d6));
	...
	public void test06() {
		...
		Assert.assertEquals(Piece.KING_BLACK, tablero.getPiece(PiecePositioned.KING_BLACK.getKey()));
		Assert.assertEquals(Piece.ROOK_BLACK, tablero.getPiece(Square.h8));
		Assert.assertEquals(Piece.BISHOP_WHITE, tablero.getPiece(Square.d5));
	...
	public void test07() {
		...
		Assert.assertEquals(Piece.ROOK_BLACK, tablero.getPiece(Square.a8));
		Assert.assertEquals(Piece.ROOK_BLACK, tablero.getPiece(Square.h8));
		Assert.assertEquals(Piece.ROOK_WHITE, tablero.getPiece(Square.e5));
	...
	public void testCapturedPositions() {
		...
		Assert.assertEquals(Piece.KING_BLACK, tablero.getPiece(Square.g2));
