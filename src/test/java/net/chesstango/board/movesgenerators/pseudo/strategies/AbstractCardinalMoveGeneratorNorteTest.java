...
public class AbstractCardinalMoveGeneratorNorteTest {
	...
	public void testNorte() {
		...
		Assert.assertEquals(Piece.ROOK_WHITE, tablero.getPiece(from));
	...
	public void testNorte01() {
		...
		Square from = Square.e5;
		Assert.assertEquals(Piece.ROOK_WHITE, tablero.getPiece(from));
		Assert.assertEquals(Piece.BISHOP_WHITE, tablero.getPiece(Square.e8));
	...
	public void testNorte02() {
		...
		Square from = Square.e5;
		Assert.assertEquals(Piece.ROOK_WHITE, tablero.getPiece(from));
		Assert.assertEquals(Piece.BISHOP_BLACK, tablero.getPiece(Square.e8));
