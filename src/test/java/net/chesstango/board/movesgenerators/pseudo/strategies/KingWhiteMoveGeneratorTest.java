...
public class KingWhiteMoveGeneratorTest {
	...
	public void test01() {
		...
		Assert.assertEquals(Piece.KING_WHITE, tablero.getPiece(from));
	...
	public void test02() {
		...
		Square from = Square.e5;
		Assert.assertEquals(Piece.KING_WHITE, tablero.getPiece(from));
		Assert.assertEquals(Piece.PAWN_WHITE, tablero.getPiece(Square.e6));
		Assert.assertEquals(Piece.PAWN_BLACK, tablero.getPiece(Square.e4));
	...
	public void test03() {
		...
		Assert.assertEquals(Piece.KING_WHITE, tablero.getPiece(PiecePositioned.KING_WHITE.getKey()));
		Assert.assertEquals(Piece.ROOK_WHITE, tablero.getPiece(Square.a1));
	...
	public void test04() {
		...
		Assert.assertEquals(Piece.KING_WHITE, tablero.getPiece(PiecePositioned.KING_WHITE.getKey()));
		Assert.assertEquals(Piece.ROOK_WHITE, tablero.getPiece(Square.a1));
		Assert.assertEquals(Piece.BISHOP_BLACK, tablero.getPiece(Square.f3));
	...
	public void test05() {
		...
		Assert.assertEquals(Piece.KING_WHITE, tablero.getPiece(PiecePositioned.KING_WHITE.getKey()));
		Assert.assertEquals(Piece.ROOK_WHITE, tablero.getPiece(Square.a1));
		Assert.assertEquals(Piece.BISHOP_BLACK, tablero.getPiece(Square.f4));
	...
	public void test06() {
		...
		Assert.assertEquals(Piece.KING_WHITE, tablero.getPiece(PiecePositioned.KING_WHITE.getKey()));
		Assert.assertEquals(Piece.ROOK_WHITE, tablero.getPiece(Square.a1));
		Assert.assertEquals(Piece.KNIGHT_WHITE, tablero.getPiece(Square.b1));
	...
	public void test07() {
		...
		Assert.assertEquals(Piece.KING_WHITE, tablero.getPiece(PiecePositioned.KING_WHITE.getKey()));
		Assert.assertEquals(Piece.ROOK_WHITE, tablero.getPiece(Square.h1));
	...
	public void test08() {
		...
		Assert.assertEquals(Piece.KING_WHITE, tablero.getPiece(PiecePositioned.KING_WHITE.getKey()));
		Assert.assertEquals(Piece.ROOK_WHITE, tablero.getPiece(Square.h1));
		Assert.assertEquals(Piece.BISHOP_BLACK, tablero.getPiece(Square.d3));
	...
	public void test09() {
		...
		Assert.assertEquals(Piece.KING_WHITE, tablero.getPiece(PiecePositioned.KING_WHITE.getKey()));
		Assert.assertEquals(Piece.ROOK_WHITE, tablero.getPiece(Square.h1));
		Assert.assertEquals(Piece.BISHOP_BLACK, tablero.getPiece(Square.d4));
	...
	public void test10() {
		...
		Assert.assertEquals(Piece.KING_WHITE, tablero.getPiece(PiecePositioned.KING_WHITE.getKey()));
		Assert.assertEquals(Piece.ROOK_WHITE, tablero.getPiece(Square.h1));
		Assert.assertEquals(Piece.PAWN_BLACK, tablero.getPiece(Square.g2));
	...
	public void test11() {
		...
		Assert.assertEquals(Piece.ROOK_WHITE, tablero.getPiece(Square.a1));
		Assert.assertEquals(Piece.ROOK_WHITE, tablero.getPiece(Square.h1));
		Assert.assertEquals(Piece.ROOK_BLACK, tablero.getPiece(Square.e4));
