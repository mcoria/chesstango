...
public class PawnWhiteMoveGeneratorTest {
    ...
    public void testAtaqueIzquierda() {
        ...
        Assert.assertEquals(Piece.PAWN_WHITE, tablero.getPiece(from));
        Assert.assertEquals(Piece.PAWN_BLACK, tablero.getPiece(Square.d3));
    ...
    public void testAtaqueDerecha() {
        ...
        Square from = Square.e2;
        Assert.assertEquals(Piece.PAWN_WHITE, tablero.getPiece(from));
        Assert.assertEquals(Piece.PAWN_BLACK, tablero.getPiece(Square.f3));
    ...
    public void testPawnCapturaPawnPromocion() {
        ...
        Assert.assertEquals(Piece.PAWN_WHITE, tablero.getPiece(from));
        Assert.assertEquals(Piece.ROOK_BLACK, tablero.getPiece(Square.c8));
        Assert.assertEquals(Piece.ROOK_BLACK, tablero.getPiece(Square.d8));
