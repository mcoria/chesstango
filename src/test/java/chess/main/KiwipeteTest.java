...
public class KiwipeteTest {
	...
	public void test_e2b5() {		
		...
		assertFalse(result.moveExists(Square.d7 , Square.d6 ));	// Si el peon se mueve, el rey negro queda en jaque
	...
	public void test_a1b1() {
		...
		assertFalse(board.getTablero().getBoardState().isCastlingWhiteReinaPermitido());
