...
public class BoardTest01 {
	...
	@Test
	public void test01() {
		Board tablero = builder.constructFEN("r1bqkb1r/pppp1Qpp/2n4n/4p3/2B1P3/8/PPPP1PPP/RNB1K1NR b KQkq - 0 1")
				.getBuilder().buildBoard();
	...
	@Test
	public void test02() {
		Board tablero = builder.constructFEN("rnb1kbnr/pp1ppppp/8/q1p5/8/3P4/PPPKPPPP/RNBQ1BNR w KQkq - 0 1").getBuilder().buildBoard();
	...
	public void testJuegoEnroqueBlancoJaque() {		
		Board tablero = builder.constructFEN("r3k3/8/8/8/4r3/8/8/R3K2R w KQq - 0 1").getBuilder().buildBoard();
	...
	public void testJuegoPeonPromocion() {
		Board tablero = builder.constructFEN("r3k2r/p1ppqpb1/bn1Ppnp1/4N3/1p2P3/2N2Q2/PPPBBPpP/R4RK1 b kq - 0 2").getBuilder().buildBoard();
	...
	public void testJuegoPeonPasanteUndo() {
		...
		Board tablero = builder.constructFEN("rnbqkbnr/pppppppp/8/1P6/8/8/P1PPPPPP/RNBQKBNR b KQkq - 0 2").getBuilder().buildBoard();
