...
public class EvaluatorImp04Test extends EvaluatorTestCollection {
    ...
    public void testEvaluateByPosition() {
        Game game = FENParser.loadGame("r3kb1r/1p3ppp/p7/P1pp2n1/3n1R2/6q1/1PPPB1b1/RNBQ2K1 b kq - 1 21");
        evaluator.setGame(game);
    ...
    public void testEvaluateSymmetric01() {
        Game game = FENParser.loadGame("r1bqkb1r/ppp1pppp/2n2n2/3p4/3P4/2N2N2/PPP1PPPP/R1BQKB1R w KQkq d6 0 4");
        evaluator.setGame(game);
    ...
    public void testEvaluation03() {
        Game game = FENParser.loadGame("r2qnrnk/p2b2b1/1p1p2pp/2pPpp2/1PP1P3/PRNBB3/3QNPPP/5RK1 w - - 0 1");
        evaluator.setGame(game);
    ...
    public void testEvaluation04() {
        Game game = FENParser.loadGame("r1b2rk1/2q1b1pp/p2ppn2/1p6/3QP3/1BN1B3/PPP3PP/R4RK1 w - - 0 1");
        evaluator.setGame(game);
    ...
    public void testEvaluation05() {
        Game game = FENParser.loadGame("1r4k1/pp3p1p/3p2pB/4r3/P7/1P1P1K2/3R2BP/8 w - - 0 31");
        evaluator.setGame(game);
